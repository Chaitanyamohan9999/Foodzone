...
public class CustomDateTimePicker implements View.OnClickListener {
    ...
    public CustomDateTimePicker(Activity a, long minimumTime, ICustomDateTimeListener customDateTimeListener) {
        activity = a;
    ...
    public View getDateTimePickerLayout() {
        ...
        datePicker.setMinDate(minimumTime);
//        timePicker.setmi(System.currentTimeMillis()+30);
    ...
    public void showDialog() {
        if (!dialog.isShowing()) {
            ...
            selectedMinute = calendar_date.get(Calendar.MINUTE)+30;
